  ...
  return {
    ...
    "--gradient":
      props.variant === "white"
        ...
        : `radial-gradient(circle, #ff6b4a 10%, #e74c3c 20%),
                  radial-gradient(circle at 40% 40%, #ff6b4a 5%, #e74c3c 15%),
                  radial-gradient(circle at 60% 60%, #ff6b4a 10%, #e74c3c 20%), 
                  radial-gradient(circle at 40% 60%, #ff6b4a 10%, #e74c3c 20%),
                  repeating-conic-gradient(
                    from 236.84deg at 50% 50%,
                    #ff6b4a 0%,
                    #e74c3c calc(25% / var(--repeating-conic-gradient-times)),
                    #ff6b4a calc(50% / var(--repeating-conic-gradient-times)), 
                    #e74c3c calc(75% / var(--repeating-conic-gradient-times)),
                    #ff6b4a calc(100% / var(--repeating-conic-gradient-times))
                  )`,
  };
});
